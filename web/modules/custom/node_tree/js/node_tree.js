  ...
  Drupal.behaviors.node_tree_open_tree_at = {
    attach: function (context, settings) {
        ...
        /*
          ...
          $.get('/node_tree/api/getExpandedTreePathToNode', getExpandedTreePathToNodeCallback );
          //$.get('/node_tree/api/getExpandedTreePathToRoot', getExpandedTreePathToNodeCallback );
        }
        */
